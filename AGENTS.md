...
- **`ADR-2026-07-18-bounded-terminal-workarea-leases.md`** — Crash-recoverable, finite lease on the exact terminal workarea; exclusive ownership spans verification, release follows explicit result acknowledgement, expiry exceeds the complete settlement budget, and reclamation is bounded. Amends `003`, `011`, and `013`. OSS-only.
