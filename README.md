...
- **`ADR-2026-07-18-bounded-terminal-workarea-leases.md`** — A terminal result exchange may retain the exact workarea under a crash-recoverable, finite lease; exclusive session ownership spans verification, release follows explicit result acknowledgement, expiry exceeds the complete settlement budget, and expired-lease reclamation is bounded. Amends `003`, `011`, and `013`. OSS-only.
